<template>
  <div class="terms-of-service wide-view">
    <h2>ClimateIQ Terms of Service</h2>

    <p>
      <strong>Last updated May 24, 2024</strong>
    </p>
    <h3>AGREEMENT TO OUR LEGAL TERMS</h3>
    <p>
      We are The New School ("<strong>Company</strong>," "<strong>we</strong>,"
      "<strong>us</strong>," "<strong>our</strong>"), a company registered in
      New York, United States at 66 West 12th Street, New York, NY 10011.
    </p>
    <p>
    ...
    <p>
      You can contact us by phone at 1-212-229-2036, email at
      info@climateiq.org, or by mail to Urban Systems Lab, The New School, 79
      5th Avenue, 16th Floor, New York, NY 10003, United States.
    </p>
    <p>
      ...
      The New School, concerning your access to and use of the Services. You
    ...
    <p>
      ...
      upon posting or notifying you by info@climateiq.org, as stated in the
      email message. By continuing to use the Services after the effective date
    ...
    <p>
      ...
      your request to: info@climateiq.org. If we ever grant you the permission
    ...
    <h3 id="purchases">5. PURCHASES AND PAYMENT</h3>
    <p>All purchases are non-refundable.</p>
    <p>We accept the following forms of payment: $USD</p>
    <p>
      ...
      any time. All payments shall be in $USD.
    </p>
    <p>
    ...
    <ul>
      ...
      <li>
        ...
        mechanisms" or "pcms"). Interfere with, disrupt, or create an undue
      ...
      <li>
        ...
        restrict access to the Services, or any portion of the Services. Copy or
        adapt the Services' software, including but not limited to Flash, PHP,
    ...
    <h3 id="ugc">7. USER GENERATED CONTRIBUTIONS</h3>
    <p>
    ...
    <h3 id="license">8. CONTRIBUTION LICENSE</h3>
    <p>
    ...
    <h3 id="thirdparty">9. THIRD-PARTY WEBSITES AND CONTENT</h3>
    <p>
    ...
    <h3 id="sitemanage">10. SERVICES MANAGEMENT</h3>
    <p>
    ...
    <h3 id="ppyes">11. PRIVACY POLICY</h3>
    <p>
    ...
    <h3 id="terms">12. TERM AND TERMINATION</h3>
    <p>
    ...
    <h3 id="modifications">13. MODIFICATIONS AND INTERRUPTIONS</h3>
    <p>
    ...
    <h3 id="law">14. GOVERNING LAW</h3>
    <p>
      These Legal Terms and your use of the Services are governed by and
      construed in accordance with the laws of the State of New York applicable
      to agreements made and to be entirely performed within the State of New
      York, without regard to its conflict of law principles.
    </p>
    <h3 id="disputes">15. DISPUTE RESOLUTION</h3>
    <p>
    ...
    <p>
      ...
      applicable law, the arbitration will take place in United States, New
      York. Except as otherwise provided herein, the Parties may litigate in
    ...
    <p>
      ...
      courts located in United States, New York, and the Parties hereby consent
    ...
    <h3 id="liability">18. LIMITATIONS OF LIABILITY</h3>
    <p>
      ...
      ARISING OR . CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
    ...
    <h3 id="userdata">20. USER DATA</h3>
    <p>
    ...
    <h3 id="california">22. CALIFORNIA USERS AND RESIDENTS</h3>
    <p>
    ...
    <h3 id="misc">23. MISCELLANEOUS</h3>
    <p>
    ...
    <h3 id="contact">24. CONTACT US</h3>
    <p>
